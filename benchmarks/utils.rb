...
$resource.each do |w|
  eval "#{ Hanami::CygUtils::String.classify(w) }Controller = Class.new($resource_controller)"
end

$resources.each do |w|
  eval "#{ Hanami::CygUtils::String.classify(w) }Controller = Class.new($resources_controller)"
end
